...
def main():
    ...
    game(win, answersList, availableLifes) # Quiz Game
...
def game(win, answersList, availableLifes):
    questionCount = 0
    incorrect = 0
    correct = 0
    ...
    while questionCount != 11:
        ...
        q1 = Question(win, 1, 16)
        questionTitle1, question1, userAnswer, submit  = q1.makeQuestion(questionTitleList, questionsList)
        win.getMouse()
        ...
        # Question 2:
        questionCount = questionCount + 1
        q2 = Question(win, 2, 12)
        questionTitle2, question2, userAnswer, submit  = q2.makeQuestion(questionTitleList, questionsList)
        win.getMouse()
        ...
        # Question 3:
        questionCount = questionCount + 1
        q3 = Question(win, 3, 16)
        questionTitle3, question3, userAnswer, submit  = q3.makeQuestion(questionTitleList, questionsList)
        win.getMouse()
        ...
        # Question 4:
        questionCount = questionCount + 1
        q4 = Question(win, 4, 14)
        questionTitle4, question4, userAnswer, submit  = q4.makeQuestion(questionTitleList, questionsList)
        win.getMouse()
        ...
        # Question 5:
        questionCount = questionCount + 1      
        q5 = Question(win, 5, 16)
        questionTitle5, question5, userAnswer, submit  = q5.makeQuestion(questionTitleList, questionsList)
        win.getMouse()
        ...
        # Question 6:
        questionCount = questionCount + 1
        q6 = Question(win, 6, 10)
        questionTitle6, question6, userAnswer, submit  = q6.makeQuestion(questionTitleList, questionsList)
        win.getMouse()
        ...
        # Question 7:
        questionCount = questionCount + 1
        q7 = Question(win, 7, 12)
        questionTitle7, question7, userAnswer, submit  = q7.makeQuestion(questionTitleList, questionsList)
        win.getMouse()
        ...
        # Question 8:
        questionCount = questionCount + 1
        q8 = Question(win, 8, 14)
        questionTitle8, question8, userAnswer, submit  = q8.makeQuestion(questionTitleList, questionsList)
        win.getMouse()
        ...
        # Question 9:
        questionCount = questionCount + 1
        q9 = Question(win, 9, 10)
        questionTitle9, question9, userAnswer, submit  = q9.makeQuestion(questionTitleList, questionsList)
        win.getMouse()
        ...
        # Question 10:
        questionCount = questionCount + 1
        q10 = Question(win, 10, 12)
        questionTitle10, question10, userAnswer, submit  = q10.makeQuestion(questionTitleList, questionsList)
        win.getMouse()
